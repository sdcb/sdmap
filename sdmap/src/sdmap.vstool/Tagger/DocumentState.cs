...
namespace sdmap.Vstool.Tagger
{
    class DocumentState
    {
        ...
        public DocumentState(ISdmapLexer lexer, ITextSnapshot version)
        {
            this.lexer = lexer;
        ...
        public static DocumentState CreateAndRegister(ISdmapLexer lexer, ITextBuffer buffer)
        {
            DocumentState state;
